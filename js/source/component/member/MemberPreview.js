    ...
    {/* USER PREVIEW FOOTER */}
    {
      vikinger_constants.plugin_active.buddypress_friends &&
        <div className="user-preview-footer">
          ...
          <div className="user-preview-footer-action">
          {
            messagePermissions.createMessage && vikinger_constants.plugin_active.buddypress_messages && props.loggedUser && (props.loggedUser.id !== props.data.id) && friendable.isFriend() &&
...
export { MemberPreview as default };