...
function AvatarSquareMicro(props) {
  ...
  return (
    <Element  className={`user-avatar-circle user-avatar-circle-flat micro ${noBorderClasses} ${props.modifiers || ''}`}
...
export { AvatarSquareMicro as default };