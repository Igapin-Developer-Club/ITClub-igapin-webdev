...
function PostPreviewGallery(props) {
  const titleWordLimit = 75;
  const excerptWordLimit = 220;
      ...
      props.sharePopupActivity &&
        <div className="post-preview-gallery">
          <div className="post-preview-gallery-slider">
            <div className="post-preview-gallery-slider-item" style={{background: `url(${props.data.gallery[0].url}) center center / cover no-repeat`}}></div>
          </div>
        </div>
    }
...
export { PostPreviewGallery as default };